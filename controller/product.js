...
const getProductFile = catchErrorAsync(async (req, res, next) => {
  const products = await sequelize.query(
    `SELECT productName, productModel, productPrice,productCurrency, productQuantity,productMeasure, adressName from products left join adresses on products.adressId=${req.params.adressId} GROUP BY products.id ORDER BY products.productQuantity ASC`,
    {
